# PowerShell script to overwrite DonorDashboard.tsx with updated content
# Run this in your project root to apply the updated component file, then commit locally.
...
Write-Host "Now run these commands to commit locally:"
Write-Host "git add -A"
Write-Host "git commit -m \"Donor dashboard: full-screen header, modal details with editable fields and India state/district hospital filter\""
